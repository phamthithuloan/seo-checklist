        ...
        <div className="relative p-6 md:p-8 flex flex-col md:flex-row items-center md:items-stretch gap-6">
          <div className="relative h-44 w-44 shrink-0">
            ...
            <div className="absolute inset-0 grid place-items-center">
              <div className="text-center">
                <p className="text-5xl font-bold tracking-tight text-slate-900 dark:text-slate-100 num">{result.score}</p>
                <p className="text-xs uppercase tracking-wider text-slate-500 dark:text-slate-400 mt-1">/ 100</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 min-w-0 flex flex-col justify-center">
            ...
            <div className="mt-5 space-y-4">
              <div>
                <div className="flex items-center justify-between text-[11px] uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5">
                  <span>Score progress</span>
                  <span className="num text-slate-700 dark:text-slate-300 font-semibold normal-case tracking-normal">
                    {result.score}/100
                  </span>
                </div>
                <div
              ...
              <div>
                ...
                <div className="mt-2 flex flex-wrap gap-x-5 gap-y-1 text-xs text-slate-600 dark:text-slate-400">
